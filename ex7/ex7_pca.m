...
plot(X(:, 1), X(:, 2), 'bo');
axis([0.5 6.5 2 8]); axis square; % creates both axis os same scale
...
%  normalization has been performed using the featureNormalize function.
%  Return values are X_norm, mu and sigma
...
components that describe the largest variations (Figure). If you want, you
