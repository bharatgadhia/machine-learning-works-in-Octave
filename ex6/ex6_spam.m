...
%  ------------
#{
  After completing the feature extraction functions, the next step of
  ...
  ex6 spam.m will proceed to train a SVM to
...
% Extract Features
file_contents = readFile('emailSample2.txt'); %readFile('emailSample1.txt');
...
%  vector for a given email.readFile('emailSample2.txt');
...
filename = 'spamSample2.txt';  %'spamSample1.txt';
